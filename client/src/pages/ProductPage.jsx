...
const ProductPage = () => {
    ...
    return (
        <div className="grid md:grid-cols-2 gap-8 md:gap-12">
            ...
            <div className="w-full h-104 overflow-hidden rounded-lg shadow-lg ">
                ...
                <img src={`${BACKEND_URL}${product.imageUrl}`} alt={product.name} className="w-full h-full object-contain " />
            </div>
